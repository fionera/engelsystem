...
class AngelTypes
{
     ...
     * @var string|null
     *
     * @ORM\Column(name="contact_name", type="string", length=250, nullable=true)
     */
    private $contactName;
     ...
     * @var string|null
     *
     * @ORM\Column(name="contact_dect", type="string", length=5, nullable=true)
     */
    private $contactDect;
     ...
     * @var string|null
     *
     * @ORM\Column(name="contact_email", type="string", length=250, nullable=true)
     */
